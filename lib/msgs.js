const msgs_texto = {
    ...
    info: {
        ...
        info:{
            resposta: "*Criador do Bot* : Dreynus\n"+
            "*Nome do bot* : {p2}\n"+
            "*Online desde* : {p3}\n"+
            "*Comandos executados* : {p4}\n"+
            "*Contato do criador* : wa.me/5518998075660\n"+
            "*Versão atual* : {p6}\n"
        },
        meusdados:{
        ...
        changelog:{
            atualizacoes: '*Changelog* - Versão 1.5.2\n\n *Novos Comandos*:\n -> !macacometro - Mede o nivel de macaquice de uma pessoa.\n -> !brisometro - Mede o quão brisada a pessoa está.\n -> !piada - Conta uma piada aleatória.\n -> !gato - Envia imagens aleatórias de gatos.\n\n *Correções*:\n -> Corrigido erro de formatação em algumas piadas exibidas pelo !piada.\n -> Problemas com a exibição de imagens no !gato foram resolvidos.\n -> Comandos de medidores agora funcionam com o criador do BOT.'
        }
    },
    figurinhas: {
        sticker:{
    ...
    diversao: {
        ...
        macacometro:{
            respostas : [' 0%\n\n - HUMANO SEM TRAÇO PRIMATA',
            '🙈 20% - HUMANO COM TRAÇOS PRIMATA, COMEÇANDO A SE DESCOBRIR',
            '🙈🙈🙈 40% - MACACO EM TREINAMENTO, JA VAI DE PAU EM PAU',
            '🙉🙉🙉 60% - MACACO TOTAL, APENAS COME E CAGA',
            '🙉🙉🙉🙉 80%\n\n - MACACO SELVAGEM, SÓ PENSA EM BANANA',
            '🙉🙉🙉🙉🙉 100%\n\n - MACACO LOUCO DE PEDRA, O CENTRO DAS ATENÇÕES EM QUALQUER BAGUNÇA'],
            apenas_um: "[❗] Erro! Apenas um membro por vez deve ser mencionado.",
            resposta: "🧩 *MACACOMETRO* - {p1}"
        },
        pirokometro:{
            respostas : ['0%\n\n - NESSA BUNDA NADA ENTRA',
            '8=D 20%\n\n - SÓ A PONTINHA',
            '8==D 40%\n\n - PORTA ABERTA PRA VISITA',
            '8===D 60%\n\n - AGUENTA UMA PIKA INTEIRA',
            '8====D 80%\n\n - ESSE CU IMPLORA POR PIROKA',
            '8=====D 100%\n\n - EITA CABA SAFADO/A, AGUENTA MAIS PIKA QUE ATRIZ PORNÔKKKKKKK'],
            apenas_um: "[❗] Erro! Apenas um membro por vez deve ser mencionado.",
            resposta: "🧩 *PIROKOMETRO* - {p1}"
        },
        brisometro:{
            respostas : ['0%\n\n SOBRIEDADE TOTAL, NADA DE BRISA AQUI',
            '🍁  20%\n\n - TA COMEÇANDO A VIAJAR',
            '🍁🍁  40%\n\n - JÁ TÁ COM A CABEÇA NAS NUVENS',
            '🍁🍁🍁  60%\n\n - NÃO SABE NEM ONDE TA E NEM O QUE TÁ FALANDO',
            '🍁🍁🍁🍁  80%\n\n - QUE PORRA É ESSA?????',
            '🍁🍁🍁🍁🍁  100%\n\n - JÁ FOI PARAR EM OUTRA DIMENSÃO JÁ, TA BRISADASSO E FALANDO MERDA'],
            apenas_um: "[❗] Erro! Apenas um membro por vez deve ser mencionado.",
            resposta: "🧩 *BRISOMETRO* - {p1}"
        },
        piadas: {
            respostas : ['Qual foi a última coisa que passou pela cabeça da princesa Diana?\n\n O rádio',
            ...
            'Mulher: Porque é que comeste a minha irmã?\n Homem: Ela estava toda nua em cima da minha mesa de trabalho, que querias que fizesse?\n Mulher: A autópsia!',
            'O que é que uma preta gravida faz quando quer ajudar a combater o crime?\n\n Um aborto.',
            'Um preto e um cigano vão num carro, quem vai a conduzir?\n\n Um polícia.',
            'O que acontece se um preto cair em cima de um monte de bosta?\n\n O monte fica maior.',
            'A minha filha perguntou-me como morrem as estrelas.\n\n “Normalmente de overdose”, disse-lhe.',
            'Comprei um ralador de queijo para o aniversário do meu amigo cego.\n\n Mais tarde, ele disse-me que era o livro mais violento que ele já tinha lido.',
            'O meu avô disse que a minha geração depende muito da tecnologia mais recente. Então desliguei o suporte de vida dele.'],
        },

        motivar:{
            resposta: "Que se foda, eu sou perfeito."
        },
        gozei:{
            resposta: "Você gozou no *{p1}* 💦💦"
        },
        chance:{
    ...
    admin: {
        ...
        infocompleta:{
            resposta_superior:"*Criador do Bot* : Dreynus\n"+
            "*Nome do bot* : {p2}\n"+
            "*Online desde* : {p3}\n"+
            "*Versão* : {p4}\n"+
            "-------------------\n",
    ...
    tipos: {
        ...
        carlin: "Carlin",
        ganso: "Ganso",
        maninha: "Marido da Aninha",
        nhaissa: "Namorado da Haissa"
    },
    api: {
