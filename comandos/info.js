    ...
    try{
        ...
        switch(command){
            case "!info":
                ...
                var resposta = criarTexto(msgs_texto.info.info.resposta, process.env.NOME_ADMINISTRADOR.trim(), "Morpheu's BOT", botInicializacaoData, infoBot.cmds_executados, ownerNumber, version)
